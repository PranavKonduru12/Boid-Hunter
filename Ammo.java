 ...
 */
public abstract class Ammo extends Actor
{
    ...
    public boolean hit(Class clss)
    {
        ...
        return actor != null;
        */
       List<Boid>targets = getObjectsInRange(10,Boid.class);
       if (targets!=null) {
           for (Boid b : targets) {
    ...
    public void scatterBirds(){
         List<Boid>targets = getObjectsInRange(180,Boid.class);
       if (targets!=null) {
           for (Boid b : targets) {
               b.setDirection((int)Math.toDegrees(Math.atan2(b.getY()-getY(), b.getX()-getX())));
            }
        }    
    }   
}
